...
myPdb = PDBFile('BoltornG4Dry10K.pdb')

#Time of the step in 10k run
time_10K = np.linspace(4*10000/20, 4*10000, 20)
...
# Radius of gyration of the structurejjjjjjjjj
